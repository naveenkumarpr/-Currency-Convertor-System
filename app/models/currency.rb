class Currency < ApplicationRecord
  ...
  class << self
    def make_rate_api_call(currency)
    ...
    def check_rate_updated_at(from_currency, to_currency)
      ...
      if f_curr_rate_time_diff > 30
        make_rate_api_call(from_currency)
      end
      if t_curr_rate_time_diff > 30
        make_rate_api_call(to_currency)
      end
    end
    ...
    def convert(from_currency, to_currency, value)
      ...
      check_rate_updated_at(from_currency, to_currency)
